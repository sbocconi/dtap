...
SECRET_KEY = 'django-insecure-a9n_b#99bb@r*+gu_#am=@6=!6ou=7lnkw0i3vo2)!d5k0!kw='
...
ROOT_URLCONF = 'dtap.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, "dtap", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dtap.wsgi.application'
...
CMS_TEMPLATES = (
    ...
    ("no-sidebar.html", _("Helios No Sidebar")),
)
